 ...
 * @author maiez
 */
public class ServiceCoursAhmed {
    
    public static ServiceCoursAhmed instance = null;
    private ConnectionRequest req;
    public boolean r;
    
    
    public static ServiceCoursAhmed getInstance()
    {
        if (instance == null)
        
            instance = new ServiceCoursAhmed();
            return instance;
        
    }
    public ServiceCoursAhmed()
    {
        req= new ConnectionRequest();
    }

    public boolean ajouterInvCours(CoursAhmed cours)
    {
    ...
    public ArrayList<CoursAhmed>afficherCours()
    {
        ArrayList<CoursAhmed> result = new ArrayList<>();

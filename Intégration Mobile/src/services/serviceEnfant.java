...
public class serviceEnfant {
 ...
 public boolean resultOK;
    ...
    public boolean addEnfant(Enfant e){
         ...
         String url = Statics.BASE_URL +"/ajouterEnfant?nomenfant="+e.getNomenfant()+"&prenomenfant="+e.getPrenomenfant()+"&age="+e.getAge()+"&idparent="+e.getIdparent()+"&password="+e.getPassword()+"&image="+e.getImage();
         req.setUrl(url);

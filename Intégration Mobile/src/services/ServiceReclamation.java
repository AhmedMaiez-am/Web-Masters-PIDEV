...
public class ServiceReclamation {
    ...
    public void ajouterReclamation(Reclamation reclamation){
          String url = Statics.BASE_URL + "/addReclamation?nom="+ reclamation.getNom()+ "&prenom=" + reclamation.getPrenom()+ "&email=" + reclamation.getEmail()+ "&reclamation=" + reclamation.getReclamation()+ "&type=" + reclamation.getType()+ "&etat=" + reclamation.getEtat(); //création de l'URL

 ...
 * @author HP
 */
public class Listeconseil extends BaseForm{
      Form current;
    public Listeconseil (Resources res){
    
        super("Liste conseil",BoxLayout.y());
        ...
        ArrayList<Conseil> List = services.ServiceConseilForm.getInstance().AfficheConseils();
            for (Conseil con : List)
        {
        ...
        EncodedImage encImage = EncodedImage.createFromImage(placeholder, false);
         URLImage urlim = URLImage.createToStorage(encImage,urlImage,urlImage,URLImage.RESIZE_SCALE);
            ...
            addButton(urlim,con,res);
            Button modifier = new Button("Modifier");
            modifier.addActionListener(mod->{
                new ModifierCon(res,con).show();
            });
            Button Supp = new Button("Supprimer");
            Supp.addActionListener(sup->{
                services.ServiceConseilForm s=new services.ServiceConseilForm();
                s.deleteConseil(con.getIdc());
   ...
   private void bindButtonSelection(Button b, Label arrow) {
    ...
    private void addButton(Image img,Conseil con,Resources res) {
       ...
       Button image = new Button(img.fill(width, height));
        ...
        Label Nomtxt = new Label ("Nom : "+con.getNomc(),"NewsTopLine2");
        Label Prenomtxt = new Label ("Prenom : "+con.getPrenomc(),"NewsTopLine2");
        Label Conseiltxt = new Label ("Conseil : "+con.getConseil(),"NewsTopLine2");
     ...
     /*   Label lSupprimer = new Label ("Sup");
        ...
        cnt.add(BorderLayout.CENTER, BoxLayout.encloseY(BoxLayout.encloseX(Nomtxt),BoxLayout.encloseX(Prenomtxt),BoxLayout.encloseX(Conseiltxt)));
        add(cnt);
                }
}
